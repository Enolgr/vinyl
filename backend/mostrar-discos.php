...
$sql = "SELECT id_album, img, nombre_album, nombre_artista, precio FROM albums a JOIN artistas ar ON a.artista = ar.id_artista JOIN genero ON id_genero = a.genero WHERE publicado =1";
